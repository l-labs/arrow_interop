...
__flatbuffers_build_table(flatbuffers_, org_apache_arrow_flatbuf_RecordBatch, 5)
...
#define __org_apache_arrow_flatbuf_RecordBatch_formal_args ,\
  int64_t v0, org_apache_arrow_flatbuf_FieldNode_vec_ref_t v1, org_apache_arrow_flatbuf_Buffer_vec_ref_t v2, org_apache_arrow_flatbuf_BodyCompression_ref_t v3, flatbuffers_int64_vec_ref_t v4
#define __org_apache_arrow_flatbuf_RecordBatch_call_args ,\
  v0, v1, v2, v3, v4
...
__flatbuffers_build_vector_field(4, flatbuffers_, org_apache_arrow_flatbuf_RecordBatch_variadicBufferCounts, flatbuffers_int64, int64_t, org_apache_arrow_flatbuf_RecordBatch)
...
static inline org_apache_arrow_flatbuf_RecordBatch_ref_t org_apache_arrow_flatbuf_RecordBatch_create(flatbuffers_builder_t *B __org_apache_arrow_flatbuf_RecordBatch_formal_args)
{
    if (org_apache_arrow_flatbuf_RecordBatch_start(B)
        ...
        || org_apache_arrow_flatbuf_RecordBatch_variadicBufferCounts_add(B, v4)) {
        return 0;
    }
...
static org_apache_arrow_flatbuf_RecordBatch_ref_t org_apache_arrow_flatbuf_RecordBatch_clone(flatbuffers_builder_t *B, org_apache_arrow_flatbuf_RecordBatch_table_t t)
{
    ...
    if (org_apache_arrow_flatbuf_RecordBatch_start(B)
        ...
        || org_apache_arrow_flatbuf_RecordBatch_variadicBufferCounts_pick(B, t)) {
        return 0;
    }
