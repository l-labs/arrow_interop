...
static int org_apache_arrow_flatbuf_ListView_verify_table(flatcc_table_verifier_descriptor_t *td);
static int org_apache_arrow_flatbuf_LargeListView_verify_table(flatcc_table_verifier_descriptor_t *td);
...
static int org_apache_arrow_flatbuf_Utf8View_verify_table(flatcc_table_verifier_descriptor_t *td);
static int org_apache_arrow_flatbuf_BinaryView_verify_table(flatcc_table_verifier_descriptor_t *td);
...
static int org_apache_arrow_flatbuf_Type_union_verifier(flatcc_union_verifier_descriptor_t *ud)
{
    ...
    case 23: return flatcc_verify_union_table(ud, org_apache_arrow_flatbuf_BinaryView_verify_table); /* BinaryView */
    case 24: return flatcc_verify_union_table(ud, org_apache_arrow_flatbuf_Utf8View_verify_table); /* Utf8View */
    case 25: return flatcc_verify_union_table(ud, org_apache_arrow_flatbuf_ListView_verify_table); /* ListView */
    case 26: return flatcc_verify_union_table(ud, org_apache_arrow_flatbuf_LargeListView_verify_table); /* LargeListView */
...
static inline int org_apache_arrow_flatbuf_ListView_verify_as_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, org_apache_arrow_flatbuf_ListView_identifier, &org_apache_arrow_flatbuf_ListView_verify_table);
}

static inline int org_apache_arrow_flatbuf_ListView_verify_as_typed_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, org_apache_arrow_flatbuf_ListView_type_identifier, &org_apache_arrow_flatbuf_ListView_verify_table);
}

static inline int org_apache_arrow_flatbuf_ListView_verify_as_root_with_identifier(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root(buf, bufsiz, fid, &org_apache_arrow_flatbuf_ListView_verify_table);
}

static inline int org_apache_arrow_flatbuf_ListView_verify_as_root_with_type_hash(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &org_apache_arrow_flatbuf_ListView_verify_table);
}
...
static inline int org_apache_arrow_flatbuf_LargeListView_verify_as_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, org_apache_arrow_flatbuf_LargeListView_identifier, &org_apache_arrow_flatbuf_LargeListView_verify_table);
}

static inline int org_apache_arrow_flatbuf_LargeListView_verify_as_typed_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, org_apache_arrow_flatbuf_LargeListView_type_identifier, &org_apache_arrow_flatbuf_LargeListView_verify_table);
}

static inline int org_apache_arrow_flatbuf_LargeListView_verify_as_root_with_identifier(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root(buf, bufsiz, fid, &org_apache_arrow_flatbuf_LargeListView_verify_table);
}

static inline int org_apache_arrow_flatbuf_LargeListView_verify_as_root_with_type_hash(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &org_apache_arrow_flatbuf_LargeListView_verify_table);
}
...
static inline int org_apache_arrow_flatbuf_Utf8View_verify_as_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, org_apache_arrow_flatbuf_Utf8View_identifier, &org_apache_arrow_flatbuf_Utf8View_verify_table);
}

static inline int org_apache_arrow_flatbuf_Utf8View_verify_as_typed_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, org_apache_arrow_flatbuf_Utf8View_type_identifier, &org_apache_arrow_flatbuf_Utf8View_verify_table);
}

static inline int org_apache_arrow_flatbuf_Utf8View_verify_as_root_with_identifier(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root(buf, bufsiz, fid, &org_apache_arrow_flatbuf_Utf8View_verify_table);
}

static inline int org_apache_arrow_flatbuf_Utf8View_verify_as_root_with_type_hash(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &org_apache_arrow_flatbuf_Utf8View_verify_table);
}
...
static inline int org_apache_arrow_flatbuf_BinaryView_verify_as_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, org_apache_arrow_flatbuf_BinaryView_identifier, &org_apache_arrow_flatbuf_BinaryView_verify_table);
}

static inline int org_apache_arrow_flatbuf_BinaryView_verify_as_typed_root(const void *buf, size_t bufsiz)
{
    return flatcc_verify_table_as_root(buf, bufsiz, org_apache_arrow_flatbuf_BinaryView_type_identifier, &org_apache_arrow_flatbuf_BinaryView_verify_table);
}

static inline int org_apache_arrow_flatbuf_BinaryView_verify_as_root_with_identifier(const void *buf, size_t bufsiz, const char *fid)
{
    return flatcc_verify_table_as_root(buf, bufsiz, fid, &org_apache_arrow_flatbuf_BinaryView_verify_table);
}

static inline int org_apache_arrow_flatbuf_BinaryView_verify_as_root_with_type_hash(const void *buf, size_t bufsiz, flatbuffers_thash_t thash)
{
    return flatcc_verify_table_as_typed_root(buf, bufsiz, thash, &org_apache_arrow_flatbuf_BinaryView_verify_table);
}
